...
export const ROLE_PERMISSIONS: Record<Role, Array<{ permission: Permission; scope: Scope }>> = {
  ...
  LEADER: [
    ...
    { permission: "division.view", scope: "GLOBAL" },
    { permission: "division.create", scope: "GLOBAL" },
    { permission: "division.update", scope: "GLOBAL" },
    { permission: "division.delete", scope: "GLOBAL" },
  ],
  CO_LEADER: [
    { permission: "user.view", scope: "GLOBAL" },
    { permission: "division.view", scope: "GLOBAL" },
  ...
  WEB_COORDINATOR: [
    { permission: "division.view", scope: "GLOBAL" },
    { permission: "division.update", scope: "DIVISION" },
