...
const serverSchema = z
  .object({
    ...
    RESEND_FROM_AUTH: z.string().email().optional(),
    RESEND_FROM_ASSIGNMENTS: z.string().email().optional(),
    RESEND_FROM_QUIZZES: z.string().email().optional(),
    RESEND_FROM_GRADES: z.string().email().optional(),
    RESEND_FROM_CERTIFICATES: z.string().email().optional(),
    RESEND_FROM_EVENTS: z.string().email().optional(),
    RESEND_FROM_ANNOUNCEMENTS: z.string().email().optional(),
